            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="alert alert-success border-0 d-flex align-items-start">
                        <div>
                            <i class="fas fa-{{ strtolower($currentQueue->vehicle_type) === 'mobil' ? 'car' : (strtolower($currentQueue->vehicle_type) === 'motor' ? 'motorcycle' : 'truck') }} fa-2x me-3"></i>
                        </div>
                        <div>
                            ...
                            <p class="mb-0"><strong>Pemilik:</strong> {{ $currentQueue->owner_name ?? 'Tidak diketahui' }}</p>
                        </div>
                    </div>
                    @else
                        ...
                        <table class="table table-hover align-middle w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>
                                        <i class="fas fa-{{ strtolower($booking->vehicle_type) === 'mobil' ? 'car' : (strtolower($booking->vehicle_type) === 'motor' ? 'motorcycle' : 'truck') }} text-secondary me-2"></i>
