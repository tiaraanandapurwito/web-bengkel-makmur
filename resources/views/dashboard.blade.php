                        ...
                        <form id="bookingForm" action="{{ route('user.booking.store') }}" method="POST"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="datetime-local" name="service_date"
                                    class="form-control form-control-lg shadow-sm" id="service_date" required>
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            vehicleTypeSelect.addEventListener('change', function() {
                ...
                if (selectedVehicle) {
                    // Mengambil data layanan dari server menggunakan AJAX
                    fetch(`/get-services?vehicle_type=${selectedVehicle}`, {
                            headers: {
